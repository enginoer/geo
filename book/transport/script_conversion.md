...
This page documents how the Python script on the example page was made by asking GitHub Copilot to convert a Matlab script. The Python code ran without error when tested in a Jupyter notebook.
